...
<template>
	<view @click="onclick" class="d-inline-block tm-switch " >
		<view class="tm-switch-wk relative ">
			...
			<!-- bar -->
			<view :animation="changValue===true?animationOn:animationOff" class="tm-switch-wk-bar absolute rounded white  flex-center " 
		...
		methods: {
			aniinit(){
				...
				var animation2 = uni.createAnimation({
				   ...
				   this.animationOff.right('inherit').translateX(uni.upx2px(4)).step()
